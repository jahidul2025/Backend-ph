...
export const createDoctorZodSchema = z.object({
    ...
    password: z.string("password is required and it must be string").min(6, "password must be at lest 6 characters").max(20, "password must be at most 20 characters"),
